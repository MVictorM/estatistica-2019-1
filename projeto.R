...
notasmaiornove = gotdf[gotdf$Nota >= 9,]["Nota"]
print(notasmaiornove)

#5-Faça uma função que retorna o nome dos episódios com menor e maior notas,
#nessa ordem para cada uma das temporadas. Por fim, faça um dataframe com cada episódio encontrado com as colunas TÍTULO, NOTA, TEMPORADA ordenados de forma crescente por temporada
#(de 1 até 8).
...
#mostra a frequência de aparição desse personagem a cada temporada. Não esqueça de dar um título e fazer ele de forma colorida, facilitando a visualização. Um exemplo para o 
